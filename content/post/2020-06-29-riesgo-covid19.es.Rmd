...
Las variables: `neumonía`, `diabetes mellitus` (DM), `EPOC` (Enfermedad Pulmonar Obstructiva Crónica), `asma`, `inmunosupresión`, `hipertensión`, `enfermedad cardiovascular`, `obesidad`, `enfermedad renal crónica` y `tabaquismo`, indican si el caso presenta esa condición o no; la variable `otra comorbilidad` indica si el caso presenta alguna otra comorbilidad.
